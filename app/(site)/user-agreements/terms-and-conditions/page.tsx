...
export default function TermsAndConditionsPage() {
  return (
    <main>
      ...
      <section className="max-w-[1300px] mx-auto mt-20 space-y-10 text-white/70 p-3 sm:p-4 leading-relaxed">
        <div>
          <Image
            src="/slash.png"
            alt="Slashes"
        ...
        <div className="relative z-10 space-y-6">
          <p className="mt-6">
            ...
            use of Layerd Pvt Ltd's Website, located at https://www.Layerd.com.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Layerd if you do not agree to
        ...
        <div>
          <div>
            <h1 className="relative uppercase mt-4 text-xl md:text-2xl bg-gradient-to-b from-white to-gray-600 font-bold text-transparent bg-clip-text z-10">
              Cookies
            </h1>
          </div>
          <div className="space-y-6">
            <p className="mt-6">
              We employ the use of cookies. By accessing Layerd, you agreed to
              use cookies in agreement with the Layerd Pvt Ltd's Privacy Policy.
            </p>
            <p>
        ...
        <div>
          ...
          <div className="space-y-6">
            <p className="mt-6">
              Unless otherwise stated, Layerd Pvt Ltd and/or its licensors own
              the intellectual property rights for all material on Layerd. All
              intellectual property rights are reserved. You may access this
              from Layerd for your own personal use subjected to restrictions
              set in these terms and conditions.
            </p>
            <ul>
              <h1 className="font-bold text-white">You must not:</h1>
              <li className="list-disc pr-7 translate-x-6">
                Republish material from Layerd
              </li>
              <li className="list-disc pr-7 translate-x-6">
                Sell, rent or sub-license material from Layerd
              </li>
              <li className="list-disc pr-7 translate-x-6">
                Reproduce, duplicate or copy material from Layerd
              </li>
              <li className="list-disc pr-7 translate-x-6">
                Redistribute content from Layerd
              </li>
            </ul>
            <p>
            ...
            <p>
              ...
              Layerd Pvt Ltd does not filter, edit, publish or review Comments
              prior to their presence on the website. Comments do not reflect
              the views and opinions of Layerd Pvt Ltd,its agents and/or
              ...
              applicable laws, Layerd Pvt Ltd shall not be liable for the
            ...
            <p>
              Layerd Pvt Ltd reserves the right to monitor all Comments and to
            ...
            <ul>
              ...
              <li className="list-disc pr-7 translate-x-6">
                You hereby grant Layerd Pvt Ltd a non-exclusive license to use,
        ...
        <div>
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              Layerd Pvt Ltd; and (d) the link is in the context of general
            ...
            <p>
              ...
              by sending an e-mail to Layerd Pvt Ltd. Please include your name,
            ...
            <p>
              No use of Layerd Pvt Ltd's logo or other artwork will be allowed
        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            <div className="space-y-6">
              <ul className="relative z-10 mt-6">
