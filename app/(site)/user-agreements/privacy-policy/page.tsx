    ...
    <main>
      ...
      <section className="max-w-[1300px] mx-auto mt-20 space-y-14 p-3 sm:p-4 leading-relaxed text-white/70">
        <div className="space-y-6">
          <p>
            At Layerd, accessible from{" "}
            <Link href="https://www.Layerd.com" className="underline">
              https://www.Layerd.com
            </Link>
            , one of our main priorities is the privacy of our visitors. This
            Privacy Policy document contains types of information that is
            collected and recorded by Layerd and how we use it.
          </p>
          <p>
          ...
          <p>
            ...
            that they shared and/or collect in Layerd. This policy is not
        ...
        <div className="space-y-6">
          ...
          <p className="relative z-10 mt-6">
            Layerd follows a standard procedure of using log files. These files
        ...
        <div className="space-y-6">
          ...
          <p className="relative z-10 mt-6">
            Like any other website, Layerd uses "cookies". These cookies are
        ...
        <div className="space-y-6">
          ...
          <p className="relative z-10 mt-6">
            ...
            advertising partners of Layerd.
          </p>
          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Layerd, which are
          ...
          <p>
            Note that Layerd has no access to or control over these cookies that
        ...
        <div className="space-y-6">
          ...
          <p className="relative z-10 mt-6">
            Layerd's Privacy Policy does not apply to other advertisers or
        ...
        <div className="space-y-6">
          ...
          <p>
            Layerd does not knowingly collect any Personal Identifiable
        ...
        <div className="space-y-6">
          ...
          <Link href={"legal@Layerd.com"} className="underline">
            legal@Layerd.com
          </Link>
        </div>
      </section>
