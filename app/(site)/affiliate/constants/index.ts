export const cardData = [
  ...
  },
  {
    ...
    title: "promote",
    description:
      "Use your unique referral link to promote Layerd.com on your website, blog, social media, webinars, tutorial videos, or any other platform.",
  },
  {
...
export const affiliateData = [
  {
    icon: "/svgs/Vector9.svg",
    title: "Be Part of the AI Revolution:",
    description:
      "With Layerd, you're not just earning, you're contributing to the AI revolution. Our platform is at the forefront of AI technology, constantly evolving and improving. By becoming an affiliate, you're joining us on this exciting journey.",
  },
  {
    icon: "/svgs/Group 1000008701.svg",
  ...
  {
    icon: "/svgs/Group 1000008702.svg",
    title: "Real-Time Tracking and Transparent Reporting:",
    description:
  ...
  {
    icon: "/svgs/Group 1000008703.svg",
  ...
  {
    icon: "/svgs/Group 1000008702.svg",
    title: "Easy to Join, Easier to Earn:",
    description:
...
export const supportOptions = [
  {
    title: "Email Support:",
    description:
      "Our email support is available round-the-clock. Send your queries or concerns to affiliates@Layerd.com, and our team will get back to you as soon as possible.",
  },
  {
    title: "Live Chat:",
    description:
