    ...
    <main>
      <div className="w-full min-h-[60vh] sm:min-h-fit sm:h-[50vh] relative">
        ...
        <div className="w-full h-full flex flex-col sm:justify-center sm:items-center gap-10 sm:gap-5 py-28 px-2 sm:p-3">
          ...
          <p className="sm:text-center max-w-3xl text-white/80">
            Welcome to the Layerd.com Affiliate Program! We're excited to have
      ...
      <section className="max-w-[1400px] mx-auto mt-20 p-3 sm:p-4">
        ...
        <div className="space-y-10 mt-20">
          ...
          <div>
            <Image
              src="/background-image-Layerd-demo.png"
              alt="whop-me-admin"
              width={1920}
              height={1080}
              draggable={false}
          ...
          <div className="mt-10 md:mt-20 ring-2 p-5 pb-10 md:py-14 lg:px-28 ring-gray-400/60 bg-neutral-700/20 rounded-3xl relative z-10">
            <div className="flex flex-col lg:flex-row items-start justify-center gap-4">
              <div className="w-full space-y-6">
                <h1 className="relative z-20 uppercase mt-4 text-2xl md:text-3xl bg-gradient-to-b from-white to-gray-600  max-w-3xl font-bold text-transparent text-left bg-clip-text">
                  Layerd Affiliate Program - Empowering You to Empower Others
                </h1>
                <p className="max-w-2xl text-sm text-white/80 leading-relaxed">
                  At Layerd, we believe in the power of AI to transform lives
            ...
            <div className="flex flex-col lg:flex-row-reverse justify-center items-center gap-10 -mt-16">
              <div className="w-full space-y-6">
                ...
                <p className="max-w-2xl text-sm text-white/80 leading-relaxed">
                  Sign up for the Layerd Affiliate Program today and start
                  earning. Welcome to the future of AI. Welcome to Layerd.
                </p>
              </div>
              <div>
                <Image
        ...
        <div className="mt-20">
          ...
          <div className="w-full space-y-6">
            ...
            <p className="text-sm text-white/80 leading-relaxed">
              At Layerd.com, we believe in the power of collaboration and
          ...
          <div className="flex flex-col gap-3 sm:flex-row items-start relative z-10">
            ...
            <div className="w-full my-4">
              <p className="tracking-tight leading-tight text-white/80">
                ...
                have achieved with Layerd.com. Here are some of the testimonials
        ...
        <div className="mt-20 space-y-10">
          ...
          <div className="flex flex-col relative z-10">
            ...
            <p className="mt-4">
              At Layerd.com, we value and appreciate the hard work of our
          ...
          <div className="space-y-6 ">
            ...
            <p className="text-white text-sm leading-relaxed font-bold">
              Join us today and start earning with Layerd.com, your one-stop
