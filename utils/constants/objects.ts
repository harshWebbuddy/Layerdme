export const labels = [
  {
    icon: "/labels/icons8-twitter.svg",
    title: "Twitter",
    link: "#",
  },
  {
    icon: "/labels/icons8-instagram.svg",
    title: "Instagram",
    link: "#",
  },
  {
    icon: "/labels/icons8-discord.svg",
    title: "Discord",
    link: "#",
  },
  {
    icon: "/labels/icons8-linkedin.svg",
    title: "Linkedin",
    link: "#",
  },
];
...
export const menuSections = [
  {
    title: "Solutions",
    items: [
      { text: "AI Search Engine", link: "#ai-search" },
      { text: "AI Chatbots", link: "#ai-chat" },
      { text: "AI Image", link: "#ai-image" },
      { text: "AI Writing", link: "#ai-writing" },
      { text: "AI Voice", link: "#ai-voice" },
      { text: "AI Code", link: "#ai-codes" },
      { text: "Personalize AI", link: "#ai-personalized" },
      { text: "Create Your Own GPT", link: "#create-your-own" },
      { text: "AI Tools", link: "#ai-tools" },
      { text: "Wolfram Alpha", link: "#ai-tools" },
    ],
  },
  {
    title: "Company",
    items: [
      ...
      { text: "Send feedback</br>(Layerd.canny.io)", link: "/contact-us" },
    ],
  },
  {
    title: "Resources",
    items: [
      ...
      { text: "App Status", link: "/app-status" },
      { text: "Prompts Engineering", link: "#" },
      { text: "Community", link: "#" },
    ],
  },
  {
    title: "Support",
    items: [
      { text: "Getting Started", link: "/getting-started/ai-chatbots" },
      { text: "Help Center", link: "/help-center" },
      { text: "FAQs", link: "/faq" },
      { text: "Talk to Person", link: "#" },
...
export const heroTools = [
  {
    icons: "/gifs/ai-code.gif",
    title: "AI Codes",
    link: "ai-codes",
  },
  {
    icons: "/gifs/voice-mic.gif",
    title: "AI voice",
    link: "ai-voice",
  },
  {
    icons: "/gifs/image-giffy.gif",
    title: "AI Images",
    link: "ai-images",
  },
  {
    icons: "/gifs/search-list.gif",
  ...
  {
    icons: "/gifs/hamburger.gif",
    title: "Create your own",
    link: "create-yours",
  },
  {
    icons: "/gifs/person-user.gif",
    title: "Contact us",
    link: "user-form",
  },
];
...
export const writingOptions = [
  {
    image: "/landing/AI-writing-1.png",
  ...
  {
    image: "/landing/AI-writing-2.png",
...
export const AiPersonaObject = [
  {
    image: "/landing/AI Personalization-1.png",
    title: "Interior AI",
    description:
  ...
  {
    image: "/landing/AI Personalization-6.png",
    title: "Create Avatar",
    description:
  ...
  {
    image: "/landing/AI Personalization-2.png",
    title: "Movie AI",
    description:
  ...
  {
    image: "/landing/AI Personalization-3.png",
    title: "Age AI",
    description:
  ...
  {
    image: "/landing/AI Personalization-4.png",
    title: "Weather GPT",
    description:
  ...
  {
    image: "/landing/AI Personalization-5.png",
    title: "Interview AI",
    description:
